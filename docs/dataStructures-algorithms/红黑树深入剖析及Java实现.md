...
![img](https://pic1.zhimg.com/80/v2-e64df5b2126506c59bad4604d298d818_1440w.png)
...
![img](https://pic1.zhimg.com/80/v2-caf8927ad71613b1f93393931029b5a4_1440w.png)
...
1. 每一个节点不是红色的就是黑色的
2. 根节点是黑色的
3. 红色节点下必须是两个黑色的节点（父子节点之间不能出现两个连续的红色节点）
4. 所有的叶节点（树的末梢节点）都是黑色的空节点
5. 根节点遍历到任意一个叶节点（树的末梢节点）所经过路径上，经过的黑色节点数量相等
...
* 左旋是向左逆时针旋转，待旋转的节点从右边上升到父节点

* 右旋是向右顺时针旋转，待旋转的节点从左边上升到父节点



![img](https://pic2.zhimg.com/80/v2-b22d2a98bb0ab3b2dc08316577221e61_1440w.png)
...
![红黑树-插入操作case1](红黑树深入剖析及Java实现.assets/红黑树-插入操作case1.png)

#### 插入操作-case 2

case 2的操作是将B节点进行右旋操作，并且和父节点A互换颜色。通过该修复操作RBTree的高度和颜色都符合红黑树的定义。如果B和C节点都是右节点的话，只要将操作变成左旋就可以了。

![红黑树-插入操作case2](红黑树深入剖析及Java实现.assets/红黑树-插入操作case2-4089099.png)
...
![红黑树-插入操作case3](红黑树深入剖析及Java实现.assets/红黑树-插入操作case3.png)
...
![img](https://pic4.zhimg.com/80/v2-46e732e84148b9bca53e995689e9ba9f_1440w.png)
...
![img](https://pic2.zhimg.com/80/v2-7975d1b235cd30c0bafb716b585ba45d_1440w.png)
...
![img](https://pic3.zhimg.com/80/v2-04dbb22d25de3849d902582809198596_1440w.png)
...
![img](https://pic4.zhimg.com/80/v2-a559407bb4847a140642d16c6301d7db_1440w.png)
